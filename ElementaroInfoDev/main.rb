...
module ElementaroInfoDev
  ...
  class SelObs < Sketchup::SelectionObserver
    def onSelectionBulkChange(_s) = ElementaroInfoDev.push_selection
    def onSelectionCleared(_s) = ElementaroInfoDev.push_selection
    def onSelectedAdded(_s, _) = ElementaroInfoDev.push_selection
    def onSelectedRemoved(_s, _) = ElementaroInfoDev.push_selection
  end
  ...
  def sym_down(h) = h.transform_keys { |k| k.to_s.downcase.to_sym }
